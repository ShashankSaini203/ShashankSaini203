...
- 🛠️ Currently, I am focusing on developing a REST API solution that implements my knowledge of cutting-edge technologies used in the software industry today. I am working on - [REST API Playground](https://github.com/ShashankSaini203/RestApiPlayground) built with .Net 8, implementing Clean Architecture with CQRS and Mediator pattern, uses Autofac as IoC container, Entity Framework Core with SQLite, Dapper, Fluent validations, AutoMapper, Unit Tests, E2E Tests with Specflow and various other standard coding and best practices.
